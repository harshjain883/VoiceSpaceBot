...
async def start_private_handler(client: Client, message: types.Message):
    ...
    text = (
        ...
        "ᴄᴏʀᴇ ᴄᴀᴘᴀʙɪʟɪᴛɪᴇs:\n"
        "• ʟɪᴠᴇ ɢʀᴏᴜᴘ ᴀᴜᴅɪᴏ sᴘᴀᴄᴇs\n"
        "• ʙᴀᴄᴋɢʀᴏᴜɴᴅ & ʟᴏᴄᴋ-sᴄʀᴇᴇɴ ᴘʟᴀʏʙᴀᴄᴋ\n"
        "• ɪɴ-ʀᴏᴏᴍ ʀᴇᴀʟ-ᴛɪᴍᴇ ᴛᴇxᴛ ᴍᴇssᴀɢɪɴɢ\n"
        "• ᴀᴅᴍɪɴɪsᴛʀᴀᴛɪᴠᴇ ᴍᴏᴅᴇʀᴀᴛɪᴏɴ ᴛᴏᴏʟs\n"
        "• ᴅʏɴᴀᴍɪᴄ ᴏɴᴇ-ᴛɪᴍᴇ sᴇssɪᴏɴ ʟɪɴᴋs\n\n"
...
async def start_vc_command(client: Client, message: types.Message):
    ...
    if bot_member.status != ChatMemberStatus.ADMINISTRATOR:
        return await message.reply_text(
            "┌─ ᴘᴇʀᴍɪssɪᴏɴ ʀᴇǫᴜɪʀᴇᴅ ─┐\n\n"
            "ᴛʜᴇ ʙᴏᴛ ʀᴇǫᴜɪʀᴇs ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀ ᴘʀɪᴠɪʟᴇɢᴇs ᴛᴏ ʟᴀᴜɴᴄʜ ᴀ ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ.\n"
            "ᴘʟᴇᴀsᴇ ᴘʀᴏᴍᴏᴛᴇ ᴛʜᴇ ʙᴏᴛ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ."
        )
    ...
    if not is_owner and not is_admin:
        return await message.reply_text("ᴏɴʟʏ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀs ᴄᴀɴ ʟᴀᴜɴᴄʜ ᴀ ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ.")
    ...
    card_text = (
        "┌─ ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ ᴀᴄᴛɪᴠᴇ ─┐\n\n"
        f"ɢʀᴏᴜᴘ: {chat.title}\n"
        "ᴀᴜᴅɪᴏ: ʜɪɢʜ ᴅᴇғɪɴɪᴛɪᴏɴ\n"
        "ᴄʜᴀᴛ: ᴇɴᴀʙʟᴇᴅ\n\n"
        "ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ᴛᴏ ᴇɴᴛᴇʀ:"
    )
...
async def stop_vc_command(client: Client, message: types.Message):
    ...
    await message.reply_text(
        f"ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ ᴛᴇʀᴍɪɴᴀᴛᴇᴅ: {chat.title}\n"
        "ᴀʟʟ ᴘᴀʀᴛɪᴄɪᴘᴀɴᴛs ʜᴀᴠᴇ ʙᴇᴇɴ ᴅɪsᴄᴏɴɴᴇᴄᴛᴇᴅ."
    )
...
async def help_command(client: Client, message: types.Message):
    help_text = (
        ...
        "• /stopvc - ᴛᴇʀᴍɪɴᴀᴛᴇ ᴛʜᴇ ᴀᴄᴛɪᴠᴇ sᴘᴀᴄᴇ\n"
        "• /ping - ᴄʜᴇᴄᴋ sʏsᴛᴇᴍ ʟᴀᴛᴇɴᴄʏ\n\n"
        "ғᴇᴀᴛᴜʀᴇs:\n"
        "• ʟᴏᴄᴋ-sᴄʀᴇᴇɴ ᴀɴᴅ ʙᴀᴄᴋɢʀᴏᴜɴᴅ ᴀᴜᴅɪᴏ\n"
        "• ʀᴇᴀʟ-ᴛɪᴍᴇ ᴛᴇxᴛ ᴄʜᴀᴛ\n"
        "• ʟɪᴠᴇ ᴍᴜᴛᴇ/ᴜɴᴍᴜᴛᴇ ɪɴᴅɪᴄᴀᴛᴏʀs\n"
        "• ᴀᴜᴛᴏ-ᴇxᴘɪʀɪɴɢ ᴊᴏɪɴ ʟɪɴᴋs"
    )
...
async def ping_command(client: Client, message: types.Message):
    start = time.time()
    msg = await message.reply_text("ᴄʜᴇᴄᴋɪɴɢ ʟᴀᴛᴇɴᴄʏ...")
...
async def callback_listener(client: Client, query: types.CallbackQuery):
    ...
    if data == "cb_ping":
        ...
        await query.answer(f"ʟᴀᴛᴇɴᴄʏ: {latency}ms | ᴏᴘᴇʀᴀᴛɪᴏɴᴀʟ", show_alert=True)

    elif data == "cb_help":
        await query.answer()
        await query.message.edit_text(
            "┌─ ᴄᴏᴍᴍᴀɴᴅs ᴍᴇɴᴜ ─┐\n\n"
            "• /vc - sᴛᴀʀᴛ ᴀ ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ\n"
            "• /stopvc - ᴄʟᴏsᴇ ᴀᴄᴛɪᴠᴇ sᴘᴀᴄᴇ\n"
            "• /ping - ᴄʜᴇᴄᴋ ʟᴀᴛᴇɴᴄʏ\n\n"
            "ᴘʀᴏᴍᴏᴛᴇ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀ ᴛᴏ ʙᴇɢɪɴ.",
        ...
        await delete_room(str(chat.id))
        await query.answer("ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ ᴛᴇʀᴍɪɴᴀᴛᴇᴅ.", show_alert=False)
        await query.message.edit_text(
            f"ᴠᴏɪᴄᴇ sᴘᴀᴄᴇ ᴛᴇʀᴍɪɴᴀᴛᴇᴅ: {chat.title}\n"
            f"sᴇssɪᴏɴ ᴇɴᴅᴇᴅ ʙʏ {query.from_user.mention}."
        )
